                        ...
                        @foreach ($brands as $brand)
                            <tr id="brand-{{ $brand->id }}" >
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="text-danger w-4 h-4 mr-1" onclick="delete_brand({{ $brand->id }})">
...
@section('customejs')
    <script>
        function delete_brand(brand_id){
            ...
            $.ajax({
                    url :  "{{ route('brands.destroy', ':brand_id') }}".replace(':brand_id', brand_id), // Using replace to inject ID
