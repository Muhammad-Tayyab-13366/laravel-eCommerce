                ...
                <table class="table table-hover text-nowrap">
                    ...
                    @if($sub_categories->isNotEmpty())
                        @foreach ($sub_categories as $sub_category)
                            <tr id="sub-category-{{ $sub_category->id }}" >
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="text-danger w-4 h-4 mr-1" onclick="delete_subcategory({{ $sub_category->id }})">
...
@section('customejs')
    <script>
        function delete_subcategory(sub_category_id){
            ...
            $.ajax({
                    url :  "{{ route('sub-categories.delete', ':sub_category_id') }}".replace(':sub_category_id', sub_category_id), // Using replace to inject ID
                    ...
                    success: function(response){
                        ...
                        $(`#sub-category-${sub_category_id}`).remove();
                    },
