                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="mb-3">               
                                ...
                                <input type="text" name="name" value="{{ Auth::user()->name }}" id="name" placeholder="Enter Your Name" class="form-control">
                            </div>
                            <div class="mb-3">            
                                <label for="email">Email</label>
                                <input type="text" name="email" value="{{ Auth::user()->email }}" id="email" placeholder="Enter Your Email" class="form-control">
                            </div>
                            <div class="mb-3">                                    
