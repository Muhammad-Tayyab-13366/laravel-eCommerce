                                ...
                                <div class="col-md-3">
                                    <div class="card product-card">
                                        ...
                                        <div class="card-body text-center mt-3">
                                            <a class="h6 link" href="product.php">{{ $fproducts->title }}</a>
                                            <div class="price mt-2">
                                                <span class="h5"><strong>{{ $fproducts->price }}</strong></span>
                                                <span class="h6 text-underline"><del>{{ $fproducts->compare_price }}</del></span>
                                            </div>
                                        </div>                        
                                    </div>                                               
                                </div>
                        ...
                        @if($latest_products->isNotEmpty())
                            @foreach ($latest_products as $lproducts )
                                ...
                                <div class="col-md-3">
                                    <div class="card product-card">
                                        <div class="product-image position-relative">
                                            <a href="" class="product-img"><img class="card-img-top" src="{{ asset('storage/images/products/small/'.$lprduct_image->image) }}" alt=""></a>
                                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
                                        ...
                                        <div class="card-body text-center mt-3">
                                            <a class="h6 link" href="product.php">{{ $lproducts->title }}</a>
                                            <div class="price mt-2">
                                                <span class="h5"><strong>{{ $lproducts->price }}</strong></span>
                                                <span class="h6 text-underline"><del>{{ $lproducts->compare_price }}</del></span>
                                            </div>
                                        </div>                        
                                    </div>                                               
                                </div>
